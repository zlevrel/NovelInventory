...
import zoupyote.novelinventory.NovelCompator.NovelComparatorByName;
import zoupyote.novelinventory.NovelCompator.NovelComparatorByScore;
import zoupyote.novelinventory.NovelCompator.NovelComparatorByWriter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // A décommenter pour importer ma liste de base
//        try {
//            fillList();
//        } catch (IOException e) {
//            e.printStackTrace();
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[],int[] grantResults) {
        if (requestCode == PERMISSIONS_REQUEST) {
            if (grantResults.length == 1 &&
                ...
                if (!showRationale) {
                    Toast.makeText(this, "Write in external storage permission denied", Toast.LENGTH_SHORT).show();
                }
            }
        } else {
